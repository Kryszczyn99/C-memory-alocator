...
#define sbrk(__arg__) (assert("Proszê nie u¿ywaæ standardowej funkcji sbrk()" && 0), (void*)-1)
#define brk(__arg__) (assert("Proszê nie u¿ywaæ standardowej funkcji sbrk()" && 0), -1)
